...
const projects = [
  ...
  },
  {
    ...
    description: "A scalable API gateway built with Node.js and Docker, handling authentication, rate limiting, and service orchestration for microservices architecture.",
  ...
  },
  {
    ...
    description: "A React Native fitness app with workout tracking, progress visualization, and social features. Includes offline capabilities and health kit integration.",
  ...
  },
  {
    ...
    description: "Automated deployment pipeline with GitHub Actions, Docker containerization, and AWS infrastructure as code using Terraform.",
